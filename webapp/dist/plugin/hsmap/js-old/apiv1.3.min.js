(function() {
    ...
    window._addStat = function(cI, cH) {
        ...
        if (!_addStat._binded) {
            a2.on(_addStat._img, "load",
            function() {
                _addStat._sending = false;
                T()
            });
            a2.on(_addStat._img, "error",
            function() {
                _addStat._sending = false;
                T()
            });
    ...
    a2.object.extend(ct, {
        ...
        run: function(cF, cH) {
            ...
            for (var cG = 0,
            T = cE._callbacks.length; cG < T; cG++) {
                cE._callbacks[cG]()
            }
    ...
    BMap.register(function(cE) {
        ...
        cE.addEventListener("addoverlay",
        function(cJ) {
            var cG = cJ.target;
            if (cG instanceof V) {
                ...
                var cI = false;
                for (var cH = 0,
                cF = T._customOverlays.length; cH < cF; cH++) {
        ...
        cE.addEventListener("removeoverlay",
        function(cI) {
            var cG = cI.target;
            if (cG instanceof V) {
        ...
        cE.addEventListener("clearoverlays",
        function(cI) {
            ...
            for (var cG = 0,
            cF = T._customOverlays.length; cG < cF; cG++) {
        ...
        cE.addEventListener("infowindowopen",
        function(cG) {
    ...
    cl.prototype.draw = function(cF) {
        ...
        a2.array.each(this._customOverlays,
        function(cG) {
            cG.draw()
        });
    ...
    a2.extend(l.prototype, {
        ...
        initialize: function(T) {
            ...
            this._addDom();
            if (this.domElement) {
                a2.on(this.domElement, "mousedown",
                function(cE) {
                    aK(cE)
                })
            }
    ...
    a2.extend(bK.prototype, {
        initialize: function() {
            var T = this,
            cE = T.map;
            cE.addEventListener("loadcode",
            function() {
                T.loadTiles()
            });
            cE.addEventListener("addtilelayer",
            function(cF) {
                T.addTileLayer(cF)
            });
            cE.addEventListener("removetilelayer",
            function(cF) {
                T.removeTileLayer(cF)
            });
            cE.addEventListener("setmaptype",
            function(cF) {
                T.setMapType(cF)
            });
            cE.addEventListener("zoomstartcode",
            function(cF) {
                T._zoom(cF)
            })
        },
        ...
        removeTileLayer: function(cH) {
            ...
            var cE = cH.target;
            for (var cF = 0,
            T = cG.tileLayers.length; cF < T; cF++) {
