...
var mapImagesPath=getDistPath()+'plugin/hsmap/images/';
//(top.path+'/dist/plugin/hsmap').replace('http://','')
    ...
    function Ja(a, b) {
        if (a = x.$(a)) {
            ...
            c.K.se && (this.SX(c.K.se.controls), this.OL(c.K.se.geotableId));
            c.K.se && c.K.se.styleId && c.w2(c.K.se.styleId);
            c.K.dm = {
                dark: {
                    backColor: "#2D2D2D",
                    textColor: "#bfbfbf",
    ...
    x.extend(Ja.prototype, {
        ...
        ui: function(a) {
            a instanceof H && (this.pc = this.ve.Jm(a, this.Vb), this.ef = H.TL(a) ? new H(a.lng, a.lat) : this.ve.qh(this.pc, this.Vb))
        },
        yg: function(a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        lw: function(a) {
            a && Va(a.Be) && (a.Be(this), this.dispatchEvent(new N("onaddcontrol", a)))
        },
        mN: function(a) {
        ...
        Ia: function(a) {
            a && Va(a.Be) && (a.Be(this), this.dispatchEvent(new N("onaddoverlay", a)))
        },
        Sb: function(a) {
        ...
        ac: function(a, b) {
            b = b || this.fa();
            return this.ve.ac(a, b, this.pc, this.xb(), this.Vb)
        },
        tb: function(a, b) {
            b = b || this.fa();
            return this.ve.tb(a, b, this.pc, this.xb(), this.Vb)
        },
        Re: function(a, b) {
            if (a) {
        ...
        Nt: function(a) {
            ...
            if (a) {
                ...
                50) : (this.K.se = a, this.dispatchEvent(new N("onsetcustomstyles", a)), this.OL(b.K.se.geotableId));
                var c = {
                    style: a.style
                };
    ...
    z.ma = mapPluginPath,//z.url.proto + ("2" == z.ou ? z.url.domain.main_domain_cdn.other[0] : z.url.domain.main_domain_cdn.baidu[0]) + "/";
    ...
    var Za; (function() {
        ...
        var l = {
            send: function(a) {
                ...
                function(a, b) {
                    e.push(a + "=" + b)
                }), e.push("d=[" + c.join(",") + "]"), g ? e.push("_st=" + g) : e.push("_t=" + +new Date), f = new Image, f.src = mapImagesPath+"st.gif?" + e.join("&"), window["___pms_img_" + 1 * new Date] = f)
            }
        };
        a.prototype = {
            oc: function(a, b) {
    ...
    "2" !== z.ou && (function(a, b, c) { (function(a, b, c) {
            ...
            if (k && k.an && i() < k.an) {
                ...
                c.alog("monkey.create", {
                    ...
                    pid: "241",
                    p: "18",
                    iy:mapImagesPath+"u.gif",// "http://nsclick.baidu.com/u.gif",
                    C3: {
                        A3: 1
                    }
                });
    ...
    var Qb = {
        ...
        style: "fcoka2",
        tile: "e5n1kf",
        vectordrawlib: "v22lvk",
        newvectordrawlib: "1ycxjx",
        groundoverlay: "dcjeee",
        pointcollection: "qrt4xm",
        marker: "00kys5",
        symbol: "pchswn",
        canvablepath: "0vp1az",
        vmlcontext: "hev5xu",
        ...
        navictrl: "aljgou",
        geoctrl: "mdzssl",
        copyrightctrl: "ood3nf",
        citylistcontrol: "tcvhai",
        scommon: "mrub5f",
        local: "affyhv",
        route: "doixno",
        othersearch: "pfd1xi",
        mapclick: "qlguh0",
        buslinesearch: "dfktyz",
        hotspot: "vajg5a",
        autocomplete: "jwvmaz",
        coordtrans: "ozta4v",
    ...
    x.object.extend(I, {
        ...
        s3: {},
        aG: {
            MP: mapPluginPath + "/js-v2/getmodules?v=2.0&t=20140707",
            oU: 5E3
        },
        zC: q,
        Nd: {
    ...
    x.extend(Cc.prototype, {
        ...
        a_: function(a, b, c, d) {
            ...
            k = this.wg[g];
            k && k.Gb ? (vb(k.Gb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.se ? this.map.K.se.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Fc(k, d)), k.loaded ? this.vf() : Gc(k,
            function() {
                e.vf()
            })) : (k = this.fj[g]) && k.Gb ? (c.Pb.insertBefore(k.Gb, c.Pb.lastChild), this.wg[g] = k, vb(k.Gb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.se ? this.map.K.se.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Fc(k, d)), k.loaded ? this.vf() : Gc(k,
            function() {
                e.vf()
            })) : (k = i * Math.pow(2, f.qm() - a[2]), new H(a[0] * k, a[1] * k), d = new Q(a[0], a[1]), f = this.map.K.se ? this.map.K.se.style: "normal", d = c.getTilesUrl(d, a[2], f), k = new Hc(this, d, b, a, c), Gc(k,
            function() {
                e.vf()
            }), k.$n(), this.wg[g] = k)
        },
        ...
        Nt: function(a) {
            ...
            c = "2" == z.ou ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++) if (e.WZ == o) {
                ...
                e.getTilesUrl = function(b, d) {
                     ...
                     * 映射地址
                     */
                    var xx = 'http://192.168.15.206:8011/'+d+'/'+(e + "").replace(/-/gi, "M")+'/'+(k + "").replace(/-/gi, "M")+'.png';
    ...
    function Lc(a) {
        ...
        this.mp = o;
        Dc.call(this, this.k);
        this.D_ = top.path+'/dist/plugin/hsmap/js-v2/qt-query.js';//z.url.proto + z.url.domain.vector_traffic + "/gvd/?qt=lgvd&styles=pl&layers=tf";
        this.Cb = {
    ...
    Uc.getTilesUrl = function(a, b, c) {
         ...
         * �޸Ĳ�ѯ����ͼƬ
         * shaolantao
         * 'http://192.168.40.22/'+b+'/'+(d + "").replace(/-/gi, "M")+'/'+(a + "").replace(/-/gi, "M")+'.jpg';
         */
        //var abc = (Sc[Math.abs(d + a) % Sc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + e + (6 == x.ea.la ? "&color_dep=32&colors=50": "") + "&udt=20160106").replace(/-(\d+)/gi, "M$1");
        
        var abc = Sc[Math.abs(d + a) % Sc.length] + '/'+b+'/'+(d + "").replace(/-/gi, "M")+'/'+(a + "").replace(/-/gi, "M")+'.png';
        return abc
    ...
    Xc.getTilesUrl = function(a, b) {
        var c = a.x,
        d = a.y;
        return top.path+'/dist/plugin/hsmap/js-v2/qt-query.js';
    ...
    x.extend(Ma.prototype, {
        ...
        Xs: t("Fe"),
        wy: function(a) {
            a !== this.Fe && (this.Fe = a, this.dispatchEvent(new N("onscene_type_changed")))
        },
        rc: function(a, b, c) {
        ...
        Oc: function(a) {
            a != this.Lc && (a > Hd && (a = Hd), a < Id && (a = Id), a != this.Lc && (this.Lc = a), "cssRender" === this.dk && this.Nc(this.Ca))
        },
        rB: function() {
    ...
    S(Jd, {
        ...
        getZoom: Jd.fa,
        getLinks: Jd.XW,
        getBaiduMapUrl: Jd.XK,
        hideMapLogo: Jd.Ax,
        showMapLogo: Jd.uF,
        enableDoubleClickZoom: Jd.F1,
        disableDoubleClickZoom: Jd.u1,
        enableScrollWheelZoom: Jd.kW,
        disableScrollWheelZoom: Jd.WV,
        show: Jd.show,
        hide: Jd.U,
        addPlugin: Jd.NB,
        removePlugin: Jd.YE,
        ...
        removeOverlay: Jd.Sb,
        getSceneType: Jd.Xs,
        setPanoramaPOIType: Jd.Pt,
        exitInter: Jd.Qo,
        setInteractiveState: Jd.mF
    });
    S(window, {
    ...
    x.lang.sa(Kd, x.lang.Ba, "PanoramaOverlayBase");
    ...
    x.lang.sa(Od, Kd, "PanoramaMarker");
    ...
    function La(a) {
        ...
        if (a === q || !window.WebGLRenderingContext || x.platform.Gm && -1 == navigator.userAgent.indexOf("Android 5")) return Qd = q;
        var a = document.createElement("canvas"),
        b = p;
        try {
    ...
    var Rd = ac.prototype;
    S(Rd, {
        getPanoramaById: Rd.$o,
        getPanoramaByLocation: Rd.qj,
        getPanoramaByPOIId: Rd.sx
    });
    function $b(a) {
        Dc.call(this);
    ...
    x.extend(Sd, {
        XV: function(a, b, c) {
            ...
            "position_changed" == a && (b.data = Sd.Sd.wi(new Q(b.data.mercatorX, b.data.mercatorY)));
            c.dispatchEvent(new N("on" + a), b)
        }
    });
    var Td = Sd;
    S(Td, {
        dispatchFlashEvent: Td.XV
    });
    var Ud = {
        dP: 50
    };
    ...
    x.extend(Ud, {
                ...
                function(b) {
                    ...
                    function(b) {
                        if (b && b.id) {
                            ...
                            k = e.mL(f, m, 0, Ud.zu.width, Ud.zu.height);
        ...
        mL: function(a, b, c, d, e) {
            ...
            return (top.path+'/dist/plugin/hsmap/js-v2/qt-query.js',
            //return (Ud.Du + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
            function(a, b) {
                return f[b]
            })
        }
    ...
    ze = window.cancelRequestAnimationFrame || window.q4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout,
    Ae = oe ? " translateZ(0)": "";
    function Be(a, b) {
        var c = this,
        d;
        c.xn = "object" == typeof a ? a: Vd.getElementById(a);
        ...
        c.x = c.options.x;
        c.y = c.options.y;
        c.options.Uk = qe && c.options.Uk;
        c.options.mi = c.options.hp && c.options.mi;
        c.options.Ci = c.options.vn && c.options.Ci;
        c.options.zoom = c.options.Uk && c.options.zoom;
        c.options.Bi = re && c.options.Bi;
        c.options.zoom && xd && (Ae = "");
        c.Nb.style[fe] = c.options.Uk ? ce + "transform": "top left";
        c.Nb.style[ge] = "0";
        c.Nb.style[he] = "0 0";
        c.options.Bi && (c.Nb.style[ie] = "cubic-bezier(0.33,0.66,0.66,1)");
        c.options.Uk ? c.Nb.style[ee] = "translate(" + c.x + "px," + c.y + "px)" + Ae: c.Nb.style.cssText += ";position:absolute;top:" + c.y + "px;left:" + c.x + "px";
        c.options.Bi && (c.options.nD = o);
        c.refresh();
        c.ca(se, window);
        c.ca(te); ! pe && "none" != c.options.JO && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
    ...
    Be.prototype = {
        ...
        Ev: function(a) {
            var b;
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = Vd.createElement("div"), this.options.eF ? b.className = this.options.eF + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.Ci ? "7": "2") + "px": "width:7px;bottom:" + (this.mi ? "7": "2") + "px;top:2px;right:1px"), b.style.cssText += ";pointer-events:none;" + ce + "transition-property:opacity;" + ce + "transition-duration:" + (this.options.qW ? "350ms": "0") + ";overflow:hidden;opacity:" + (this.options.Bx ? "0": "1"), this.xn.appendChild(b), this[a + "ScrollbarWrapper"] = b, b = Vd.createElement("div"), this.options.eF || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + ce + "background-clip:padding-box;" + ce + "box-sizing:border-box;" + ("h" == a ? "height:100%": "width:100%") + ";" + ce + "border-radius:3px;border-radius:3px"), b.style.cssText += ";pointer-events:none;" + ce + "transition-property:" + ce + "transform;" + ce + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + ce + "transition-duration:0;" + ce + "transform: translate(0,0)" + Ae, this.options.Bi && (b.style.cssText += ";" + ce + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"), this[a + "ScrollbarWrapper"].appendChild(b), this[a + "ScrollbarIndicator"] = b), "h" == a ? (this.AL = this.BL.clientWidth, this.IX = Wd.max(Wd.round(this.AL * this.AL / this.ty), 8), this.HX.style.width = this.IX + "px") : (this.AO = this.BO.clientHeight, this.P_ = Wd.max(Wd.round(this.AO * this.AO / this.Fp), 8), this.O_.style.height = this.P_ + "px"), this.lB(a, o)) : this[a + "ScrollbarWrapper"] && (qe && (this[a + "ScrollbarIndicator"].style[ee] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(this[a + "ScrollbarWrapper"]), this[a + "ScrollbarWrapper"] = p, this[a + "ScrollbarIndicator"] = p)
        },
        kB: function() {
            var a = this;
            setTimeout(function() {
        ...
        xr: function(a, b) {
            this.Wk || (a = this.hp ? a: 0, b = this.vn ? b: 0, this.options.Uk ? this.Nb.style[ee] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + Ae: (a = Wd.round(a), b = Wd.round(b), this.Nb.style.left = a + "px", this.Nb.style.top = b + "px"), this.x = a, this.y = b, this.lB("h"), this.lB("v"))
        },
        lB: function(a, b) {
            var c = "h" == a ? this.x: this.y;
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.nD || (c = this[a + "ScrollbarIndicatorSize"] + Wd.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width": "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.nD ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Wd.round(3 * (c - this[a + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width": "height"] = c + "px", c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))), this[a + "ScrollbarWrapper"].style[je] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Bx ? "0": "1", this[a + "ScrollbarIndicator"].style[ee] = "translate(" + ("h" == a ? c + "px,0)": "0," + c + "px)") + Ae)
        },
        rQ: function(a) {
        ...
        Nv: function(a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (pe && 1 < a.touches.length) && (d = Wd.abs(a.touches[0].pageX - a.touches[1].pageX), c = Wd.abs(a.touches[0].pageY - a.touches[1].pageY), this.w_ = Wd.sqrt(d * d + c * c), this.$x = Wd.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.NF) / 2 - this.x, this.ay = Wd.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.OF) / 2 - this.y, this.options.vp && this.options.vp.call(this, a));
                if (this.options.Sx && (this.options.Uk ? (c = getComputedStyle(this.Nb, p)[ee].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Bi ? this.Vd(xe) : ze(this.SB),
                this.Aj = [],
                this.xr(d, c),
        ...
        QS: function(a) {
            ...
            if (this.options.zoom && pe && 1 < a.touches.length) e = Wd.abs(a.touches[0].pageX - a.touches[1].pageX),
            f = Wd.abs(a.touches[0].pageY - a.touches[1].pageY),
            this.v_ = Wd.sqrt(e * e + f * f),
            this.Wk = o,
            ...
            this.Nb.style[ee] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + Ae,
            this.options.$M && this.options.$M.call(this, a);
                ...
                this.JC += c;
                this.KC += d;
                this.ew = Wd.abs(this.JC);
                this.fw = Wd.abs(this.KC);
        ...
        $u: function(a) {
            if (! (pe && 0 !== a.touches.length)) {
                ...
                b.Nb.style[ge] = "200ms",
                b.Nb.style[ee] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Ae,
                b.Wk = q,
                b.refresh(),
                b.options.up && b.options.up.call(b, a);
                    ...
                    if (b.rh) {
                        ...
                        f.Aa || g.Aa ? (c = Wd.max(Wd.max(f.time, g.time), 10), b.options.Yt && (f = d - b.gw, g = e - b.hw, Wd.abs(f) < b.options.Dy && Wd.abs(g) < b.options.Dy ? b.scrollTo(b.gw, b.hw, 200) : (f = b.WI(d, e), d = f.x, e = f.y, c = Wd.max(f.time, c))), b.scrollTo(Wd.round(d), Wd.round(e), c)) : b.options.Yt ? (f = d - b.gw, g = e - b.hw, Wd.abs(f) < b.options.Dy && Wd.abs(g) < b.options.Dy ? b.scrollTo(b.gw, b.hw, 200) : (f = b.WI(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.io(200)
                    } else {
                        if (pe) if (b.wK && b.options.zoom) clearTimeout(b.wK),
                        b.wK = p,
                        ...
                        200);
                            ...
                            "select" != e && "input" != e && "textarea" != e ? (e = Vd.createEvent("MouseEvents"), e.initMouseEvent("click", o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, p), e.nR = o, d.dispatchEvent(e)) : d.focus()
                        }
                        b.io(400)
                    }
        ...
        io: function(a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.rh && (this.rh = q, this.options.Yx && this.options.Yx.call(this)), this.mi && this.options.Bx && ("webkit" == Yd && (this.BL.style[je] = "300ms"), this.BL.style.opacity = "0"), this.Ci && this.options.Bx)"webkit" == Yd && (this.BO.style[je] = "300ms"),
        ...
        rU: function(a) {
            a.target == this.Nb && (this.Vd(xe), this.xB())
        },
        xB: function() {
            var a = this,
            b = a.x,
            ...
            f,
            g;
            a.Vl || (a.Aj.length ? (e = a.Aj.shift(), e.x == b && e.y == c && (e.time = 0), a.Vl = o, a.rh = o, a.options.Bi) ? (a.eJ(e.time), a.xr(e.x, e.y), a.Vl = q, e.time ? a.ca(xe) : a.io(0)) : (g = function() {
                var i = Date.now(),
                k;
                if (i >= d + e.time) {
                    a.xr(e.x, e.y);
        ...
        eJ: function(a) {
            a += "ms";
            this.Nb.style[ge] = a;
            this.mi && (this.HX.style[ge] = a);
            this.Ci && (this.O_.style[ge] = a)
        },
        ...
        WI: function(a, b) {
            ...
            a = this.Qe[e];
            d = (d = Wd.abs(a - this.Qe[this.uC])) ? 500 * (Wd.abs(this.x - a) / d) : 0;
            this.uC = e;
            e = this.pf.length - 1;
            ...
            b = this.pf[e];
            c = (c = Wd.abs(b - this.pf[this.vC])) ? 500 * (Wd.abs(this.y - b) / c) : 0;
            this.vC = e;
        ...
        refresh: function() {
            ...
            this.ty = Wd.round(this.Nb.offsetWidth * this.scale);
            this.Fp = Wd.round((this.Nb.offsetHeight + this.nf) * this.scale);
            ...
            this.Ev("h");
            this.Ev("v");
            this.Wk || (this.Nb.style[ge] = "0", this.io(400))
        },
        ...
        stop: function() {
            this.options.Bi ? this.Vd(xe) : ze(this.SB);
            this.Aj = [];
            this.Vl = this.rh = q
        },
        zoom: function(a, b, c, d) {
            var e = c / this.scale;
            this.options.Uk && (this.Wk = o, d = d === j ? 200 : d, a = a - this.NF - this.x, b = b - this.OF - this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.ee ? this.ee: this.x, this.y = this.y > this.nf ? this.nf: this.y < this.od ? this.od: this.y, this.Nb.style[ge] = d + "ms", this.Nb.style[ee] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Ae, this.Wk = q)
        }
    };
    function de(a) {
        if ("" === Yd) return a;
    ...
    z.Sm(function(a) {
        ...
        function() {
            a.k.visible && a.k.albumsControl === o && (b ? b.ly(a.Yb()) : (b = new Ce(a.k.albumsControlOptions), b.pa(a)))
        });
        a.addEventListener("albums_visible_changed",
        function() {
            a.k.albumsControl === o ? (b ? b.ly(a.Yb()) : (b = new Ce(a.k.albumsControlOptions), b.pa(a)), b.show()) : b.U()
        });
        ...
        ly: function(a, b) {
            if (b || !this.bk[this.Yc] || !(this.bk[this.Yc].panoId == a && 3 !== this.bk[this.Yc].recoType)) {
                ...
                d = this.vH(a); ! b && -1 !== d && this.bk[d] && 3 !== this.bk[d].recoType ? this.Jp(d) : this.lX(function(a) {
                    ...
                    i = a[m].floor,
                    j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Ee[d]] || (b[Ee[d]] = []), b[Ee[d]].push(a[m])));
    ...
    S(He, {
        ...
        panBy: He.yg,
        setCenter: He.Vf,
        setCurrentCity: He.kF,
        setMapType: He.Bg,
        setViewport: He.Bh,
        setZoom: He.Oc,
        highResolutionEnabled: He.DL,
        zoomTo: He.Fg,
        zoomIn: He.PF,
        zoomOut: He.QF,
        addHotspot: He.nw,
        ...
        removeControl: He.mN,
        getContainer: He.Na,
        addContextMenu: He.uo,
        removeContextMenu: He.zp,
        addOverlay: He.Ia,
        removeOverlay: He.Sb,
        clearOverlays: He.$J,
        openInfoWindow: He.Mb,
        closeInfoWindow: He.Xc,
        pointToOverlayPixel: He.Re,
        overlayPixelToPoint: He.bN,
        getInfoWindow: He.jh,
        getOverlays: He.qx,
        getPanes: function() {
            return {
        ...
        addTileLayer: He.Yg,
        removeTileLayer: He.zh,
        pixelToPoint: He.tb,
        pointToPixel: He.ac,
        setFeatureStyle: He.Ip,
        selectBaseElement: He.I3,
        setMapStyle: He.Nt,
        enable3DBuilding: He.Mo,
        disable3DBuilding: He.TV,
        getPanorama: He.rm
    });
    var Ie = Qc.prototype;
    S(Ie, {
